...
public class EntityFXLaunchSmoke extends EntityFX
{
    ...
    public EntityFXLaunchSmoke(final World par1World, final Vector3 position, final Vector3 motion, final float size, final boolean launched) {
        ...
        final float particleRed = (float)(Math.random() * 0.30000001192092896) + 0.6f;
        ...
        if (launched) {
            ...
            this.motionX += par1World.rand.nextDouble() / 2.0 - 0.25;
            this.motionY += par1World.rand.nextDouble() / 20.0;
            this.motionZ += par1World.rand.nextDouble() / 2.0 - 0.25;
