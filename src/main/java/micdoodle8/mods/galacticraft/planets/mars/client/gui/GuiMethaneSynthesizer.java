...
public class GuiMethaneSynthesizer extends GuiContainerGC {
    ...
    public void initGui() {
        ...
        this.infoRegions.add(
            new GuiElementInfoRegion(edgeLeft + 152, edgeTop + 6, 18, 18, fuelSlotDesc, this.width, this.height, this));
        this.infoRegions.add(
            new GuiElementInfoRegion(edgeLeft + 131, edgeTop + 6, 18, 18, fuelSlotDesc, this.width, this.height, this));
        ...
        this.infoRegions.add(
            new GuiElementInfoRegion(edgeLeft + 6, edgeTop + 6, 18, 18, fuelSlotDesc, this.width, this.height, this));
        ...
        fuelSlotDesc.add(GCCoreUtil.translate("gui.message.withAtmosphere1.name") + ")");
        this.infoRegions.add(
            new GuiElementInfoRegion(edgeLeft + 27, edgeTop + 6, 18, 18, fuelSlotDesc, this.width, this.height, this));
    ...
    private void addToolTips() {
        ...
        if (gasTankContents != null) {
            String gasname = FluidRegistry.getFluid("hydrogen")
                .getUnlocalizedName();
            if (gasname == null || "fluid.hydrogen".equals(gasname)) {
                gasname = GCCoreUtil.translate(
        ...
        if (gasTankContents != null) {
            String gasname = FluidRegistry.getFluid("carbondioxide")
                .getUnlocalizedName();
        ...
        if (gasTankContents != null) {
            String gasname = FluidRegistry.getFluid("methane")
                .getUnlocalizedName();
