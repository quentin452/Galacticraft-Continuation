...
public class GuiElectricFurnace extends GuiContainerGC
{
    ...
    public GuiElectricFurnace(final InventoryPlayer par1InventoryPlayer, final TileEntityElectricFurnace tileEntity) {
        super((Container)new ContainerElectricFurnace(par1InventoryPlayer, tileEntity));
    ...
    protected void drawGuiContainerBackgroundLayer(final float par1, final int par2, final int par3) {
        ...
        if (this.tileEntity.processTicks > 0) {
            final int scale = (int)(this.tileEntity.processTicks / (double)this.tileEntity.processTimeRequired * 23.0);
        ...
        if (this.tileEntity.getEnergyStoredGC() > 0.0f) {
            final int scale = this.tileEntity.getScaledElecticalLevel(54);
