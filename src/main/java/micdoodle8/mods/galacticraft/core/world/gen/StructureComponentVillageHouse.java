...
public class StructureComponentVillageHouse extends StructureComponentVillage
{
    ...
    public StructureComponentVillageHouse(final StructureComponentVillageStartPiece par1ComponentVillageStartPiece, final int par2, final Random par3Random, final StructureBoundingBox par4StructureBoundingBox, final int par5) {
    ...
    public static StructureComponentVillageHouse func_74921_a(final StructureComponentVillageStartPiece par0ComponentVillageStartPiece, final List par1List, final Random par2Random, final int par3, final int par4, final int par5, final int par6, final int par7) {
