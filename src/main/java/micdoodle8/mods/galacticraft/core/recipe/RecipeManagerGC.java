...
{
    public static ArrayList<ItemStack> aluminumIngots;
    ...
    private static void addUniversalRecipes() {
        final Object meteoricIronIngot = ConfigManagerCore.recipesRequireGCAdvancedMetals ? GCItems.meteoricIronIngot : "ingotMeteoricIron";
        final Object meteoricIronPlate = ConfigManagerCore.recipesRequireGCAdvancedMetals ? new ItemStack(GCItems.meteoricIronIngot, 1, 1) : "compressedMeteoricIron";
        final Object deshIngot = GalacticraftCore.isPlanetsLoaded ? (ConfigManagerCore.recipesRequireGCAdvancedMetals ? new ItemStack(MarsItems.marsItemBasic, 1, 2) : "ingotDesh") : GCItems.heavyPlatingTier1;
        ...
        RecipeManagerGC.aluminumIngots.addAll(OreDictionary.getOres("ingotAluminum"));
        ...
        for (final ItemStack ingotNew : OreDictionary.getOres("ingotAluminium")) {
            boolean flag = false;
            for (final ItemStack ingotDone : RecipeManagerGC.aluminumIngots) {
        ...
        if (addedList.size() > 0) {
            RecipeManagerGC.aluminumIngots.addAll(addedList);
            addedList.clear();
        }
        for (final ItemStack ingotNew : OreDictionary.getOres("ingotNaturalAluminum")) {
            for (final ItemStack ingotDone2 : RecipeManagerGC.aluminumIngots) {
                if (!ItemStack.areItemStacksEqual(ingotNew, ingotDone2)) {
                    addedList.add(ingotNew);
                }
            }
        }
        ...
        GalacticraftRegistry.registerSpaceStation(new SpaceStationType(ConfigManagerCore.idDimensionOverworldOrbit, 0, new SpaceStationRecipe((HashMap)inputMap)));
        ...
        for (int i = 3; i < 6; ++i) {
            if (ItemBasic.names[i].contains("ingot")) {
                CompressorRecipes.addShapelessRecipe(new ItemStack(GCItems.basicItem, 1, i + 3), new Object[] { ItemBasic.names[i], ItemBasic.names[i] });
            }
        }
        if (OreDictionary.getOres("ingotBronze").size() > 0) {
            CompressorRecipes.addShapelessRecipe(new ItemStack(GCItems.basicItem, 1, 10), new Object[] { "ingotBronze", "ingotBronze" });
        }
        CompressorRecipes.addShapelessRecipe(new ItemStack(GCItems.basicItem, 1, 10), new Object[] { new ItemStack(GCItems.basicItem, 1, 6), new ItemStack(GCItems.basicItem, 1, 7) });
        CompressorRecipes.addShapelessRecipe(new ItemStack(GCItems.basicItem, 1, 11), new Object[] { Items.iron_ingot, Items.iron_ingot });
        CompressorRecipes.addShapelessRecipe(new ItemStack(GCItems.meteoricIronIngot, 1, 1), new Object[] { meteoricIronIngot });
        CompressorRecipes.addRecipe(new ItemStack(GCItems.heavyPlatingTier1, 2, 0), new Object[] { "XYZ", "XYZ", 'X', new ItemStack(GCItems.basicItem, 1, 9), 'Y', new ItemStack(GCItems.basicItem, 1, 8), 'Z', new ItemStack(GCItems.basicItem, 1, 10) });
    }
    ...
    public static void setConfigurableRecipes() {
        ...
        final ArrayList<ItemStack> silicons = (ArrayList<ItemStack>)OreDictionary.getOres(ConfigManagerCore.otherModsSilicon);
        for (int siliconCount = silicons.size(), j = 0; j <= siliconCount; ++j) {
            ItemStack silicon;
            if (j == 0) {
        ...
        if (OreDictionary.getOres("ingotSteel").size() > 0) {
            CompressorRecipes.addShapelessRecipe(new ItemStack(GCItems.basicItem, 1, 9), new Object[] { "ingotSteel", "ingotSteel" });
            steelDone = true;
        }
        if (!ConfigManagerCore.hardMode || !steelDone) {
            CompressorRecipes.addShapelessRecipe(new ItemStack(GCItems.basicItem, 1, 9), new Object[] { Items.coal, new ItemStack(GCItems.basicItem, 1, 11), Items.coal });
        }
        else {
            CompressorRecipes.addShapelessAdventure(new ItemStack(GCItems.basicItem, 1, 9), new Object[] { Items.coal, new ItemStack(GCItems.basicItem, 1, 11), Items.coal });
        }
    }
    ...
    private static void addBuildCraftCraftingRecipes() {
        try {
            ...
            RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.BC_ITEM_COBBLESTONEPIPE.getMetadata()), new Object[] { "XYX", 'Y', pipeItemsCobblestone, 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
            RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.BC_ITEM_STONEPIPE.getMetadata()), new Object[] { "XYX", 'Y', pipeItemsStone, 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
            RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.BC_FLUIDS_COBBLESTONEPIPE.getMetadata()), new Object[] { "XYX", 'Y', pipeFluidsCobblestone, 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
            RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.BC_FLUIDS_STONEPIPE.getMetadata()), new Object[] { "XYX", 'Y', pipeFluidsStone, 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
            RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.BC_POWER_STONEPIPE.getMetadata()), new Object[] { "XYX", 'Y', pipePowerStone, 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
            RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.BC_POWER_GOLDPIPE.getMetadata()), new Object[] { "XYX", 'Y', pipePowerGold, 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static void addIndustrialCraft2Recipes() {
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.IC2_COPPER_CABLE.getMetadata()), new Object[] { "XYX", 'Y', RecipeUtil.getIndustrialCraftItem("insulatedCopperCableItem"), 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.IC2_GOLD_CABLE.getMetadata()), new Object[] { "XYX", 'Y', RecipeUtil.getIndustrialCraftItem("insulatedGoldCableItem"), 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.IC2_GLASS_FIBRE_CABLE.getMetadata()), new Object[] { "XYX", 'Y', RecipeUtil.getIndustrialCraftItem("glassFiberCableItem"), 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.IC2_LV_CABLE.getMetadata()), new Object[] { "XYX", 'Y', RecipeUtil.getIndustrialCraftItem("insulatedTinCableItem"), 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
    }
    
    private static void addAppEngRecipes() {
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, BlockEnclosed.EnumEnclosedBlock.ME_CABLE.getMetadata()), new Object[] { "XYX", 'Y', AEApi.instance().definitions().parts().cableGlass().stack(AEColor.Transparent, 1), 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
    }
    
    private static void addExNihiloRecipes() {
        try {
            final Class registry = Class.forName("exnihilo.registries.HeatRegistry");
            final Method m = registry.getMethod("register", Block.class, Float.TYPE);
    ...
    static {
        RecipeManagerGC.aluminumIngots = new ArrayList<ItemStack>();
    }
}
