...
{
    final int renderID;
    private final TileEntityTreasureChestAsteroids chest;
    
    public BlockRendererTier3TreasureChest(final int var1) {
        this.chest = new TileEntityTreasureChestAsteroids();
        this.renderID = var1;
    }
