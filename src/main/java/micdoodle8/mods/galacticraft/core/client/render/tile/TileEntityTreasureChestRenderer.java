...
public class TileEntityTreasureChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderGCTileEntityTreasureChestAt(final TileEntityTreasureChest par1GCTileEntityTreasureChest, final double par2, final double par4, final double par6, final float par8) {
        int var9;
    ...
    static {
        treasureChestTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/model/treasure.png");
        treasureLargeChestTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/model/treasurelarge.png");
    }
}
