...
public class GuiRefinery extends GuiContainerGC
{
    ...
    public GuiRefinery(final InventoryPlayer par1InventoryPlayer, final TileEntityRefinery tileEntity) {
        super((Container)new ContainerRefinery(par1InventoryPlayer, tileEntity));
        this.fuelTankRegion = new GuiElementInfoRegion((this.width - this.xSize) / 2 + 153, (this.height - this.ySize) / 2 + 28, 16, 38, new ArrayList<String>(), this.width, this.height, this);
        this.oilTankRegion = new GuiElementInfoRegion((this.width - this.xSize) / 2 + 7, (this.height - this.ySize) / 2 + 28, 16, 38, new ArrayList<String>(), this.width, this.height, this);
        this.electricInfoRegion = new GuiElementInfoRegion((this.width - this.xSize) / 2 + 62, (this.height - this.ySize) / 2 + 16, 56, 9, new ArrayList<String>(), this.width, this.height, this);
    ...
    public void initGui() {
        ...
        final int oilLevel = (this.tileEntity.oilTank != null && this.tileEntity.oilTank.getFluid() != null) ? this.tileEntity.oilTank.getFluid().amount : 0;
        ...
        final int fuelLevel = (this.tileEntity.fuelTank != null && this.tileEntity.fuelTank.getFluid() != null) ? this.tileEntity.fuelTank.getFluid().amount : 0;
    ...
    protected void actionPerformed(final GuiButton par1GuiButton) {
        switch (par1GuiButton.id) {
            case 0: {
                GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(PacketSimple.EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, new Object[] { this.tileEntity.xCoord, this.tileEntity.yCoord, this.tileEntity.zCoord, 0 }));
                break;
            }
        }
    }
    ...
    protected void drawGuiContainerForegroundLayer(final int par1, final int par2) {
        ...
        this.fontRendererObj.drawString(GCCoreUtil.translate("gui.message.status.name") + ": " + displayText, 72, 68 + yOffset, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(final float par1, final int par2, final int par3) {
        ...
        this.drawTexturedModalRect((this.width - this.xSize) / 2 + 153, (this.height - this.ySize) / 2 + 17 + 49 - displayInt, 192, 38 - displayInt, 16, displayInt);
        final List<String> oilTankDesc = new ArrayList<String>();
        oilTankDesc.add(GCCoreUtil.translate("gui.oilTank.desc.0"));
        oilTankDesc.add(GCCoreUtil.translate("gui.oilTank.desc.1"));
        final int oilLevel = (this.tileEntity.oilTank != null && this.tileEntity.oilTank.getFluid() != null) ? this.tileEntity.oilTank.getFluid().amount : 0;
    ...
    static {
        refineryTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/refinery.png");
    }
}
