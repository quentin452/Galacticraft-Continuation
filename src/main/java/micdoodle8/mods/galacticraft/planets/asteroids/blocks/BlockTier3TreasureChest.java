...
public class BlockTier3TreasureChest extends BlockContainer implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
    ...
    public BlockTier3TreasureChest(final String assetName) {
        super(Material.rock);
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        this.blockIcon = par1IconRegister.registerIcon("galacticraftasteroids:treasureChestAsteroids");
    }
    ...
    public TileEntity createNewTileEntity(final World par1World, final int meta) {
        return (TileEntity)new TileEntityTreasureChestAsteroids();
    }
    ...
    public static boolean isOcelotBlockingChest(final World par0World, final int par1, final int par2, final int par3) {
        for (final Object var6 : par0World.getEntitiesWithinAABB(EntityOcelot.class, AxisAlignedBB.getBoundingBox((double)par1, (double)(par2 + 1), (double)par3, (double)(par1 + 1), (double)(par2 + 2), (double)(par3 + 1)))) {
            if (var6 instanceof EntityOcelot) {
