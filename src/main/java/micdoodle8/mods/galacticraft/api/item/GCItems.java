...
public class GCItems {
     ...
     * <p/>
     * Be sure to check if the itemstack is null, since items may be disabled, planets addon might not be installed,
     * etc.
     * <p/>
     * Since the items are initialized and added to list in pre-init, you should only be calling this method in init or
     * later.
     *
