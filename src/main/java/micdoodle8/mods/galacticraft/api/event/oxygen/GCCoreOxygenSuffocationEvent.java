 ...
 * <p/>
 * Be sure to make the proper checks before cancelling oxygen events... world providers, armor equipped, etc.
 */
public abstract class GCCoreOxygenSuffocationEvent extends LivingEvent {
     ...
     * <p/>
     * Set the event as canceled to stop the living entity from suffocating IF THE PRE EVENT IS CANCELED, THE "WARNING:
     * OXYGEN SETUP INVALID!" HUD MESSAGE WILL NOT BE SHOWN
     */
    @Cancelable
    ...
    /**
     * This event is called after the living entity takes damage from oxygen suffocation
     * <p/>
