...
public class ContainerOxygenCollector extends Container
{
    ...
    public ContainerOxygenCollector(final InventoryPlayer par1InventoryPlayer, final TileEntityOxygenCollector collector) {
        this.tileEntity = collector;
        this.addSlotToContainer((Slot)new SlotSpecific((IInventory)collector, 0, 32, 27, new Class[] { IItemElectric.class }));
