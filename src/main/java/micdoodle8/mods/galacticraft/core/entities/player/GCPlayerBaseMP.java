...
public class GCPlayerBaseMP extends ServerPlayerBase {
    ...
    public void clonePlayer(EntityPlayer oldPlayer, boolean keepInv) {
        ...
        this.getClientHandler()
            .clonePlayer(this.player, oldPlayer, keepInv);
    }
    ...
    public void wakeUpPlayer(boolean par1, boolean par2, boolean par3) {
        if (!this.getClientHandler()
            .wakeUpPlayer(this.player, par1, par2, par3)) {
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        par2 = this.getClientHandler()
            .attackEntityFrom(this.player, par1DamageSource, par2);
    ...
    public void knockBack(Entity p_70653_1_, float p_70653_2_, double impulseX, double impulseZ) {
        this.getClientHandler()
            .knockBack(this.player, p_70653_1_, p_70653_2_, impulseX, impulseZ);
    }
}
