...
public class RoomBossMars extends DungeonRoom
{
    ...
    public RoomBossMars(final MapGenDungeon dungeon, final int posX, final int posY, final int posZ, final ForgeDirection entranceDir) {
    ...
    protected void handleTileEntities(final Random rand) {
        ...
        if (tile == null || !(tile instanceof TileEntityDungeonSpawnerMars)) {
            final TileEntityDungeonSpawner spawner = (TileEntityDungeonSpawner)new TileEntityDungeonSpawnerMars();
