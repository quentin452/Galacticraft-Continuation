...
public class ModelNasaWorkbench extends ModelBase {
    ...
    public ModelNasaWorkbench(float var1) {
        ...
        this.setRotation(this.base2a, 0F, -((float) Math.PI / 4F), 0F);
        ...
        this.setRotation(this.baseAux3, 0F, -((float) Math.PI / 4F), 0F);
        ...
        this.setRotation(this.armRotationPointL, 0F, -(float) Math.PI, 0.5235988F);
        ...
        this.setRotation(this.baseRotationPointL, 0F, -(float) Math.PI, 0.5235988F);
