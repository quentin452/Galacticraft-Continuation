...
public class GuiLaunchController extends GuiContainerGC
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        for (k = 0; k < labelList.size(); ++k) {
            labelList.get(k)
                .func_146159_a(this.mc, par1, par2);
        }

        for (k = 0; k < infoRegions.size(); ++k) {
            infoRegions.get(k)
                .drawRegion(par1, par2);
        }
        ...
        if (Math.random() < 0.025 && !this.destinationFrequency.isTextFocused) {
            if (!Minecraft.getMinecraft().thePlayer.getGameProfile()
                .getName()
            ...
            GalacticraftCore.packetPipeline.sendToServer(
                new PacketSimpleMars(
                    ...
                    new Object[] { 3, this.launchController.xCoord, this.launchController.yCoord,
                        this.launchController.zCoord, this.launchController.launchPadRemovalDisabled ? 1 : 0 }));
            ...
            GalacticraftCore.packetPipeline.sendToServer(
                new PacketSimpleMars(
                    ...
                    new Object[] { 4, this.launchController.xCoord, this.launchController.yCoord,
                        this.launchController.zCoord, this.launchController.launchSchedulingEnabled ? 1 : 0 }));
        }
    }
