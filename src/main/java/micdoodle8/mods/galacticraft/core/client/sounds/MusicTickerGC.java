    ...
    public void update() {
        ...
        if (FMLClientHandler.instance()
            ...
            && FMLClientHandler.instance()
                .getWorldClient().provider instanceof IGalacticraftWorldProvider) {
        ...
        if (this.field_147678_c != null) {
            if (!musictype.getMusicTickerLocation()
                ...
                this.field_147677_b.getSoundHandler()
                    .stopSound(this.field_147678_c);
                this.field_147676_d = MathHelper
                    .getRandomIntegerInRange(this.field_147679_a, 0, musictype.func_148634_b() / 2);
            }

            if (!this.field_147677_b.getSoundHandler()
                .isSoundPlaying(this.field_147678_c)) {
