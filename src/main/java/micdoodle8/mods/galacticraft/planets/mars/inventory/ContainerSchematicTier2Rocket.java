...
public class ContainerSchematicTier2Rocket extends Container {
    ...
    public ContainerSchematicTier2Rocket(InventoryPlayer par1InventoryPlayer, int x, int y, int z) {
        ...
        // Cone
        this.addSlotToContainer(
            new SlotSchematicTier2Rocket(this.craftMatrix, 1, 48, -8 + change, x, y, z, par1InventoryPlayer.player));
        ...
        // Left fins
        this.addSlotToContainer(
            new SlotSchematicTier2Rocket(this.craftMatrix, 12, 21, 64 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
            new SlotSchematicTier2Rocket(this.craftMatrix, 13, 21, 82 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
            new SlotSchematicTier2Rocket(this.craftMatrix, 14, 21, 100 + change, x, y, z, par1InventoryPlayer.player));

        // Engine
        this.addSlotToContainer(
            new SlotSchematicTier2Rocket(this.craftMatrix, 15, 48, 100 + change, x, y, z, par1InventoryPlayer.player));

        // Right fins
        this.addSlotToContainer(
            new SlotSchematicTier2Rocket(this.craftMatrix, 16, 75, 64 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
            new SlotSchematicTier2Rocket(this.craftMatrix, 17, 75, 82 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
            new SlotSchematicTier2Rocket(this.craftMatrix, 18, 75, 100 + change, x, y, z, par1InventoryPlayer.player));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par1) {
        ...
        if (var3 != null && var3.getHasStack()) {
            ...
            if (par1 <= 21) {
                ...
                if (!done) {
                    if (var2.getItem() == Item.getItemFromBlock(Blocks.chest) && !this.inventorySlots.get(19)
                        .getHasStack()) {
                        if (!this.mergeOneItem(var4, 19, 20, false)) {
                            return null;
                        }
                    } else if (var2.getItem() == Item.getItemFromBlock(Blocks.chest) && !this.inventorySlots.get(20)
                        .getHasStack()) {
                            if (!this.mergeOneItem(var4, 20, 21, false)) {
                                return null;
                            }
                        } else if (var2.getItem() == Item.getItemFromBlock(Blocks.chest) && !this.inventorySlots.get(21)
                            .getHasStack()) {
