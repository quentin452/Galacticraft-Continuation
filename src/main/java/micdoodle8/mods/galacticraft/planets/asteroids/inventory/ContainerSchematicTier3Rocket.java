...
public class ContainerSchematicTier3Rocket extends Container {
    ...
    public ContainerSchematicTier3Rocket(InventoryPlayer par1InventoryPlayer, int x, int y, int z) {
        ...
        // Cone
        this.addSlotToContainer(
            new SlotSchematicTier3Rocket(this.craftMatrix, 1, 48, -8 + change, x, y, z, par1InventoryPlayer.player));
        ...
        // Left fins
        this.addSlotToContainer(
            new SlotSchematicTier3Rocket(this.craftMatrix, 12, 21, 64 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
            new SlotSchematicTier3Rocket(this.craftMatrix, 13, 21, 82 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
            new SlotSchematicTier3Rocket(this.craftMatrix, 14, 21, 100 + change, x, y, z, par1InventoryPlayer.player));

        // Engine
        this.addSlotToContainer(
            new SlotSchematicTier3Rocket(this.craftMatrix, 15, 48, 100 + change, x, y, z, par1InventoryPlayer.player));

        // Right fins
        this.addSlotToContainer(
            new SlotSchematicTier3Rocket(this.craftMatrix, 16, 75, 64 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
            new SlotSchematicTier3Rocket(this.craftMatrix, 17, 75, 82 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
            new SlotSchematicTier3Rocket(this.craftMatrix, 18, 75, 100 + change, x, y, z, par1InventoryPlayer.player));
