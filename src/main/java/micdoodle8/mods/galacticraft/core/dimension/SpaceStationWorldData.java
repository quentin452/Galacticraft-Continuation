...
public class SpaceStationWorldData extends WorldSavedData
{
    ...
    public SpaceStationWorldData(final String par1Str) {
        super(par1Str);
    ...
    public void setAllowedAll(final boolean b) {
    ...
    public void setSpaceStationName(final String string) {
    ...
    public void setDimensionIdStatic(final int dimensionIdStatic) {
    ...
    public void setDimensionIdDynamic(final int dimensionIdDynamic) {
    ...
    public void writeToNBT(final NBTTagCompound nbttagcompound) {
        ...
        nbttagcompound.setTag("dataCompound", (NBTBase)this.dataCompound);
        ...
        nbttagcompound.setTag("allowedPlayers", (NBTBase)var2);
    }
    
    public static SpaceStationWorldData getStationData(final World world, final int stationID, final EntityPlayer player) {
        return getStationData(world, stationID, -1, -1, -1, player);
    }
    
    public static SpaceStationWorldData getStationData(final World world, final int stationID, final int homeID, final int providerIdDynamic, final int providerIdStatic, final EntityPlayer owner) {
        ...
        final String stationIdentifier = getSpaceStationID(stationID);
        SpaceStationWorldData stationData = (SpaceStationWorldData)world.loadItemData((Class)SpaceStationWorldData.class, stationIdentifier);
        if (stationData == null) {
            stationData = new SpaceStationWorldData(stationIdentifier);
            world.setItemData(stationIdentifier, (WorldSavedData)stationData);
    ...
    public static SpaceStationWorldData getMPSpaceStationData(World var0, final int var1, final EntityPlayer player) {
        final String var2 = getSpaceStationID(var1);
        if (var0 == null) {
            var0 = DimensionManager.getProvider(0).worldObj;
        }
        SpaceStationWorldData var3 = (SpaceStationWorldData)var0.loadItemData((Class)SpaceStationWorldData.class, var2);
        if (var3 == null) {
            var3 = new SpaceStationWorldData(var2);
            var0.setItemData(var2, (WorldSavedData)var3);
    ...
    public static String getSpaceStationID(final int dimID) {
        return "spacestation_" + dimID;
    }
    
    public static void updateSSOwnership(final EntityPlayerMP player, final String playerName, final GCPlayerStats stats, final int stationID, SpaceStationWorldData stationData) {
        if (stationData == null) {
            stationData = getMPSpaceStationData(null, stationID, null);
        }
    ...
    public static void checkAllStations(final EntityPlayerMP thePlayer, final GCPlayerStats stats) {
        final String name = thePlayer.getGameProfile().getName().replace(".", "");
        for (final int id : WorldUtil.registeredSpaceStations.keySet()) {
            updateSSOwnership(thePlayer, name, stats, id, null);
        }
    }
}
