...
public class TileEntityTreasureChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderGCTileEntityTreasureChestAt(final TileEntityTreasureChestAsteroids par1GCTileEntityTreasureChest, final double par2, final double par4, final double par6, final float par8) {
    ...
    static {
        treasureChestTexture = new ResourceLocation("galacticraftasteroids", "textures/model/treasure.png");
        treasureLargeChestTexture = new ResourceLocation("galacticraftasteroids", "textures/model/treasurelarge.png");
    }
}
