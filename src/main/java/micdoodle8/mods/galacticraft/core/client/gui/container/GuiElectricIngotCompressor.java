...
public class GuiElectricIngotCompressor extends GuiContainerGC
{
    ...
    public GuiElectricIngotCompressor(final InventoryPlayer par1InventoryPlayer, final TileEntityElectricIngotCompressor tileEntity) {
        super((Container)new ContainerElectricIngotCompressor(par1InventoryPlayer, tileEntity));
    ...
    protected void drawGuiContainerBackgroundLayer(final float par1, final int par2, final int par3) {
        ...
        int scale;
        if (this.tileEntity.processTicks > 0) {
            scale = (int)(this.tileEntity.processTicks / (double)this.tileEntity.processTimeRequired * 100.0);
        }
        else {
            scale = 0;
        }
        ...
        if (this.tileEntity.processTicks > 0) {
            scale = (int)(this.tileEntity.processTicks / (double)this.tileEntity.processTimeRequired * 54.0);
    ...
    static {
        electricFurnaceTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/electric_IngotCompressor.png");
    }
}
