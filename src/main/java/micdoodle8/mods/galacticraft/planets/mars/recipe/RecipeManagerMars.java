...
public class RecipeManagerMars
{
    ...
    private static void addUniversalRecipes() {
        ...
        final Object deshIngot = ConfigManagerCore.recipesRequireGCAdvancedMetals ? new ItemStack(MarsItems.marsItemBasic, 1, 2) : "ingotDesh";
        final Object deshPlate = ConfigManagerCore.recipesRequireGCAdvancedMetals ? new ItemStack(MarsItems.marsItemBasic, 1, 5) : "compressedDesh";
        ...
        CraftingManager.getInstance().addShapelessRecipe(new ItemStack(MarsItems.carbonFragments, 8, 0), new Object[] { new ItemStack(Items.coal, 1, 0) });
        CraftingManager.getInstance().addShapelessRecipe(new ItemStack(MarsItems.carbonFragments, 4, 0), new Object[] { new ItemStack(Items.coal, 1, 1) });
        ...
        input.put(13, new ItemStack(GCItems.partFins));
        input2 = new HashMap<Integer, ItemStack>(input);
        input2.put(14, new ItemStack((Block)Blocks.chest));
        input2.put(15, null);
        input2.put(16, null);
        ...
        RecipeUtil.addRecipe(new ItemStack(MarsBlocks.machine, 1, 8), new Object[] { "ZVZ", "YXY", "ZWZ", 'V', new ItemStack(GCItems.basicItem, 1, 19), 'W', new ItemStack(GCBlocks.aluminumWire, 1, 0), 'X', new ItemStack(GCItems.basicItem, 1, 14), 'Y', deshPlate, 'Z', deshIngot });
    }
}
