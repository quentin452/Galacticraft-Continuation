...
public class GuiWaterElectrolyzer extends GuiContainerGC
{
    ...
    public GuiWaterElectrolyzer(final InventoryPlayer par1InventoryPlayer, final TileEntityElectrolyzer tileEntity) {
        super((Container)new ContainerElectrolyzer(par1InventoryPlayer, tileEntity));
    ...
    protected void drawGuiContainerBackgroundLayer(final float par1, final int par2, final int par3) {
        ...
        this.drawTexturedModalRect(edgeLeft + 7, edgeTop + 17 + 49 - waterLevel, 69, 38 - waterLevel, 16, waterLevel);
        int displayInt = this.tileEntity.getScaledFuelLevel(38);
        this.drawTexturedModalRect(edgeLeft + 132, edgeTop + 17 + 49 - displayInt, 18, 38 - displayInt, 16, displayInt);
        displayInt = this.tileEntity.getScaledFuelLevel2(38);
        this.drawTexturedModalRect(edgeLeft + 153, edgeTop + 17 + 49 - displayInt, 35, 38 - displayInt, 16, displayInt);
        this.addToolTips();
        this.mc.renderEngine.bindTexture(GuiWaterElectrolyzer.refineryTexture);
