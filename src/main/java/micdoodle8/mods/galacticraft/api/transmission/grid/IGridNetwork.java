...
/**
 * Implement this in your network class/interface if you plan to have your own network defined by specific conductors
 * and acceptors.
 *
...
public interface IGridNetwork<N, C, A> {
    ...
    /**
     * Creates a new network that makes up the current network and the network defined in the parameters. Be sure to
     * refresh the new network inside this method.
     *
    ...
    /**
     * Splits a network by the conductor referenced in the parameters. It will then create and refresh the new
     * independent networks possibly created by this operation.
     *
     * @param connection
     */
