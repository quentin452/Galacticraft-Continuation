...
public class RecipeManagerGC {
    ...
    private static void addUniversalRecipes() {
        ...
        FurnaceRecipes.smelting()
            .func_151394_a(new ItemStack(GCItems.meteorChunk, 1, 0), new ItemStack(GCItems.meteorChunk, 1, 1), 0.1F);
        FurnaceRecipes.smelting()
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "ZYZ", "ZWZ", "XVX", 'V', GCItems.oxygenVent, 'W', new ItemStack(GCItems.fuelCanister, 1, 1),
                'X', GCItems.heavyPlatingTier1, 'Y', new ItemStack(Blocks.wool, 1, 4), 'Z', meteoricIronPlate });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "SSS", "BBB", "SSS", 'B', new ItemStack(GCItems.battery, 1, GCItems.battery.getMaxDamage()),
                'S', "compressedSteel" });
        // Electric Furnace:
        RecipeUtil.addRecipe(
            new ItemStack(GCBlocks.machineTiered, 1, 4),
            new Object[] { "XXX", "XZX", "WYW", 'W', "compressedAluminum", 'X', "compressedSteel", 'Y', "waferBasic",
                'Z', Blocks.furnace });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "WXW", "WYW", "VZV", 'V', new ItemStack(GCBlocks.aluminumWire), 'W', "compressedSteel", 'X',
                Blocks.anvil, 'Y', "compressedBronze", 'Z', "waferAdvanced" });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "SSS", "BBB", "SSS", 'B',
                new ItemStack(GCItems.oxTankHeavy, 1, GCItems.oxTankHeavy.getMaxDamage()), 'S', "compressedSteel" });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { " YV", "XWX", "XZX", 'V', Blocks.stone_button, 'W', new ItemStack(GCItems.canister, 1, 0),
                'X', GCItems.heavyPlatingTier1, 'Y', Items.flint_and_steel, 'Z', GCItems.oxygenVent });

        RecipeUtil.addRecipe(
            new ItemStack(GCItems.rocketEngine, 1),
            new Object[] { "VY ", "XWX", "XZX", 'V', Blocks.stone_button, 'W', new ItemStack(GCItems.canister, 1, 0),
                'X', GCItems.heavyPlatingTier1, 'Y', Items.flint_and_steel, 'Z', GCItems.oxygenVent });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "YZY", "YXY", "YYY", 'X', new ItemStack(GCItems.canister, 1, 0), 'Y', "compressedAluminum",
                'Z', GCBlocks.oxygenPipe });

        RecipeUtil.addRecipe(
            new ItemStack(GCItems.oxTankLight, 1, GCItems.oxTankLight.getMaxDamage()),
            new Object[] { "YZY", "YXY", "YYY", 'X', new ItemStack(GCItems.canister, 1, 1), 'Y', "compressedAluminum",
                'Z', GCBlocks.oxygenPipe });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "ZXZ", "XYX", "ZXZ", 'X', Blocks.glass_pane, 'Y', meteoricIronPlate, 'Z', Items.redstone });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "WWW", "YVY", "ZUZ", 'U', "compressedAluminum", 'V', "waferBasic", 'W', "compressedSteel",
                'X', GCItems.oxygenFan, 'Y', GCItems.oxygenVent, 'Z', Items.redstone });

        RecipeUtil.addRecipe(
            new ItemStack(GCBlocks.oxygenDistributor, 1),
            new Object[] { "WXW", "YZY", "WXW", 'W', "compressedSteel", 'X', GCItems.oxygenFan, 'Y', GCItems.oxygenVent,
                'Z', "compressedAluminum" });
        ...
        RecipeUtil
            .addRecipe(new ItemStack(GCItems.steelHelmet, 1), new Object[] { "XXX", "X X", 'X', "compressedSteel" });

        RecipeUtil
            .addRecipe(new ItemStack(GCItems.flagPole, 2, 0), new Object[] { "X", "X", "X", 'X', "compressedSteel" });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "WVW", "YXY", "YZY", 'X', "compressedSteel", 'Y', "compressedBronze", 'Z', "waferBasic", 'W',
                Items.redstone, 'V', GCItems.oxygenVent });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "XXX", "XZX", "WYW", 'W', "compressedAluminum", 'X', "compressedSteel", 'Y', "waferBasic",
                'Z', new ItemStack(GCItems.canister, 1, 0) });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "XYX", "XZX", "VWV", 'V', new ItemStack(GCBlocks.aluminumWire, 1, 0), 'W', "waferBasic", 'X',
                "compressedSteel", 'Y', new ItemStack(GCItems.basicItem, 1, 1), 'Z', GCItems.flagPole });

        RecipeUtil.addRecipe(
            new ItemStack(GCBlocks.solarPanel, 1, 4),
            new Object[] { "XYX", "XZX", "VWV", 'V', new ItemStack(GCBlocks.aluminumWire, 1, 1), 'W', "waferAdvanced",
                'X', "compressedSteel", 'Y', new ItemStack(GCItems.basicItem, 1, 1), 'Z', GCItems.flagPole });

        RecipeUtil.addRecipe(
            new ItemStack(GCBlocks.cargoLoader, 1, 0),
            new Object[] { "XWX", "YZY", "XXX", 'W', Blocks.hopper, 'X', "compressedSteel", 'Y', "compressedAluminum",
                'Z', Blocks.chest });

        RecipeUtil.addRecipe(
            new ItemStack(GCBlocks.cargoLoader, 1, 4),
            new Object[] { "XXX", "YZY", "XWX", 'W', Blocks.hopper, 'X', "compressedSteel", 'Y', "compressedAluminum",
                'Z', Blocks.chest });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { " X ", "YUY", "ZWZ", 'U', Items.repeater, 'W', "waferBasic", 'X', "compressedAluminum", 'Y',
                "compressedIron", 'Z', Items.redstone });
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "XFX", "XWX", "YYY", 'W', "waferBasic", 'X', "compressedTin", 'Y', "compressedCopper", 'F',
                new ItemStack(GCItems.basicItem, 1, 19) });
         ...
         */
        if (OreDictionary.getOres("ingotBronze")
            .size() > 0) {
    ...
    public static void setConfigurableRecipes() {
        ...
        if (OreDictionary.getOres("ingotSteel")
            .size() > 0) {
    ...
    private static void addBuildCraftCraftingRecipes() {
        ...
        try {
            ...
            final Object pipeItemsStone = clazz.getField("pipeItemsStone")
                .get(null);
            final Object pipeItemsCobblestone = clazz.getField("pipeItemsCobblestone")
                .get(null);
            final Object pipeFluidsCobblestone = clazz.getField("pipeFluidsCobblestone")
                .get(null);
            final Object pipeFluidsStone = clazz.getField("pipeFluidsStone")
                .get(null);
            final Object pipePowerStone = clazz.getField("pipePowerStone")
                .get(null);
            final Object pipePowerGold = clazz.getField("pipePowerGold")
                .get(null);
    ...
    private static void addAppEngRecipes() {
        RecipeUtil.addRecipe(
            ...
            new Object[] { "XYX", 'Y', AEApi.instance()
                .definitions()
                .parts()
                .cableGlass()
                .stack(AEColor.Transparent, 1), 'X', new ItemStack(GCBlocks.basicBlock, 1, 4) });
    }
