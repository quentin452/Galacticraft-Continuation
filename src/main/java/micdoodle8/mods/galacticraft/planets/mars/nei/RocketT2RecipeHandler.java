...
public class RocketT2RecipeHandler extends TemplateRecipeHandler
{
    ...
    public Set<Map.Entry<ArrayList<PositionedStack>, PositionedStack>> getRecipes() {
        return (Set<Map.Entry<ArrayList<PositionedStack>, PositionedStack>>)NEIGalacticraftMarsConfig.getRocketBenchRecipes();
    }
    ...
    public String getGuiTexture() {
        return "galacticraftmars:textures/gui/schematic_rocket_T2.png";
    }
    ...
    static {
        rocketGuiTexture = new ResourceLocation("galacticraftmars", "textures/gui/schematic_rocket_T2.png");
    }
    ...
    public class CachedRocketRecipe extends TemplateRecipeHandler.CachedRecipe
    {
        ...
        public CachedRocketRecipe(final RocketT2RecipeHandler this$0, final Map.Entry<ArrayList<PositionedStack>, PositionedStack> recipe) {
