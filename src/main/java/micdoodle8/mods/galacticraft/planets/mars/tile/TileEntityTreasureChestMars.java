...
public class TileEntityTreasureChestMars extends TileEntityAdvanced implements IInventory, IKeyable
{
    ...
    public TileEntityTreasureChestMars(final int tier) {
    ...
    private void func_90009_a(final TileEntityTreasureChestMars par1TileEntityChest, final int par2) {
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote && this.numUsingPlayers != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0) {
            ...
            final float f = 5.0f;
            final List<?> list = (List<?>)this.worldObj.getEntitiesWithinAABB((Class)EntityPlayer.class, AxisAlignedBB.getBoundingBox((double)(this.xCoord - f), (double)(this.yCoord - f), (double)(this.zCoord - f), (double)(this.xCoord + 1 + f), (double)(this.yCoord + 1 + f), (double)(this.zCoord + 1 + f)));
            for (final EntityPlayer entityplayer : (List<EntityPlayer>) list) {
