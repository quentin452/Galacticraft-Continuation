...
public class ModelAlienVillager extends ModelVillager {
    ...
    public ModelAlienVillager(float par1, float par2, int par3, int par4) {
        ...
        this.villagerHead.setTextureOffset(0, 0)
            .addBox(-4.0F, -10.0F, -4.0F, 8, 10, 8, par1 + 0.001F);
        ...
        this.villagerNose.setTextureOffset(24, 0)
            .addBox(-1.0F, -1.0F, -6.0F, 2, 4, 2, par1 + 0.002F);
        ...
        this.villagerBody.setTextureOffset(16, 20)
            .addBox(-4.0F, 0.0F, -3.0F, 8, 12, 6, par1 + 0.003F);
        this.villagerBody.setTextureOffset(0, 38)
            .addBox(-4.0F, 0.0F, -3.0F, 8, 18, 6, par1 + 0.5F + 0.004F);
        ...
        this.villagerArms.setTextureOffset(44, 22)
            .addBox(-8.0F, -2.0F, -2.0F, 4, 8, 4, par1 + 0.005F);
        this.villagerArms.setTextureOffset(44, 22)
            .addBox(4.0F, -2.0F, -2.0F, 4, 8, 4, par1 + 0.0001F);
        this.villagerArms.setTextureOffset(40, 38)
            .addBox(-4.0F, 2.0F, -2.0F, 8, 4, 4, par1 + 0.0004F);
        ...
        this.brain.setTextureOffset(32, 0)
            .addBox(-4.0F, -16.0F, -4.0F, 8, 8, 8, par1 + 0.5F);
    }
