...
/**
 * Implement into tile entities that can attack to landing pads. It is recommended that you check if the landing pad at
 * the provided coordinates is valid for connection.
 */
public interface ILandingPadAttachable {

    /**
     * Determines if this tile can connect to the landing pad at the provided coordinates.
     *
